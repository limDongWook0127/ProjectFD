...
void UUI_Parts_Slot::UpdateInfo(FItemInfo_ Data_)
{
	...
	UUI_Parts_Popup* MainslotPopup = Cast<UUI_Parts_Popup>(GetWidgetFromName(TEXT("Parts_PopUp")));
...
FReply UUI_Parts_Slot::NativeOnMouseButtonDown(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
